...
const Team = ({ search, setSearch, searchResult }) => {
    ...
    const columns = [
        ...
        { field: "firstName", headerName: "firstName", flex: 0.5, cellClassName: "name-column--cell" },
        { field: "lastName", headerName: "lastName", flex: 0.5, cellClassName: "name-column--cell" },
