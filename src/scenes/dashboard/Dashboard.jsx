import { Box, Button, Stack, IconButton, Typography, useTheme } from "@mui/material";
        ...
        <Box m="20px">
            ...
            >
                ...
                <Box gridColumn="span 8" gridRow="span 2"
                    ...
                    <Typography variant="h3" ml="30px" fontWeight="600"
                        color={colors.grey[100]}>
                        $59, 342,32
                        <Box height="250px" ml="-20px" mt="-20px">
                ...
                >
                    <Box display="flex"
                        alignItems="center"
                        borderBottom={`4px solid ${colors.primary[500]}`} color={colors.grey[100]}
                        padding="15px"
                    >
                ...
                <Box gridColumn="span 4" gridRow="span 2"
                    backgroundColor={colors.primary[400]} p="30px">
                    <Typography variant="h5" fontWeight="600">
                        Campaign
                    </Typography>
                    <Box display="flex" flexDirection="column" alignItems="center" mt="25px">
                        ...
                        <Typography variant="h5" fontWeight="600">
                            Includes extra misc exenditures and costs
                        </Typography>
